...
passage = Room('Passage', 'Sleeping Quarters', 'Armory', 'Prison Cell', 'Nothing', 'Dirty Robe')
armory = Room('Armory', 'Passage', 'Nothing', 'Nothing', 'Nothing', 'Space Alloy Sword')
sleep_quar = Room('Sleeping Quarters', 'Nothing', 'Passage', 'Nothing', 'Nothing', '')
